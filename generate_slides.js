...
async function buildPresentation(data, outPath) {
  ...
  // Brand vision
  s1.addText(brandVision || "Optimized by FormulaForge \u00D7 Amazon Nova", {
  ...
  s1.addText("Powered by Amazon Nova", {
    x: 0.7, y: 3.95, w: 3, h: 0.3,
    fontSize: 7, fontFace: FONT_BODY, color: C.goldDim, charSpacing: 2,
  });

  // Right side: DALL-E 3 product image or decorative shapes
  ...
  s9.addText("Generated by FormulaForge \u00D7 Amazon Nova", {
  ...
  s9.addText("SAMI & VALERIE  \u2502  Amazon Nova Hackathon 2025", {
